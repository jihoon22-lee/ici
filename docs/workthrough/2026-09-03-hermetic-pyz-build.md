...
| Focused regression | `uv run --python 3.10 pytest -q tests/test_pyz_assembly.py tests/test_purity.py` — 45 passed. |
| Full Python 3.10 suite | `uv run --python 3.10 pytest -ra` — 2,183 passed, 7 environment-dependent C++ tool skips. |
