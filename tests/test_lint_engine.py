...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("clang-analyzer", "clang-analyzer-cplusplus.Move", FindingCategory.RESOURCE),
        ("clang-analyzer", "clang-analyzer-cplusplus.Move-extra", FindingCategory.CORRECTNESS),
        ("clang-analyzer", "clang-analyzer-cplusplus.NewDeleteLeaks", FindingCategory.RESOURCE),
        ("clang-analyzer", "clang-analyzer-cplusplus.PlacementNew", FindingCategory.RESOURCE),
        ...
        ("clang-analyzer", "clang-analyzer-unix.MallocSizeof", FindingCategory.RESOURCE),
        ...
        ("clang-tidy", "bugprone-not-null-terminated-result", FindingCategory.SECURITY),
        ("clang-tidy", "bugprone-random-generator-seed", FindingCategory.SECURITY),
        ("clang-tidy", "misc-predictable-rand", FindingCategory.SECURITY),
        ...
        ("clang-tidy", "bugprone-raw-memory-call-on-non-trivial-type", FindingCategory.RESOURCE),
        ("clang-tidy", "bugprone-return-const-ref-from-parameter", FindingCategory.RESOURCE),
        ("clang-tidy", "bugprone-suspicious-realloc-usage", FindingCategory.RESOURCE),
        ("clang-tidy", "bugprone-suspicious-memset-usage", FindingCategory.RESOURCE),
        ("clang-tidy", "bugprone-undefined-memory-manipulation", FindingCategory.RESOURCE),
        ("clang-tidy", "bugprone-unhandled-exception-at-new", FindingCategory.RESOURCE),
        ("clang-tidy", "bugprone-unused-raii", FindingCategory.RESOURCE),
        ("clang-tidy", "bugprone-use-after-move", FindingCategory.RESOURCE),
        ("clang-tidy", "cppcoreguidelines-no-malloc", FindingCategory.RESOURCE),
        ("clang-tidy", "cppcoreguidelines-owning-memory", FindingCategory.RESOURCE),
        ("clang-tidy", "cppcoreguidelines-virtual-class-destructor", FindingCategory.RESOURCE),
        ("clang-tidy", "misc-uniqueptr-reset-release", FindingCategory.RESOURCE),
        ...
        ("clang-tidy", "bugprone-not-null-terminated-result-extra", FindingCategory.CORRECTNESS),
        ...
        ("clazy", "clazy-detaching-temporary", FindingCategory.RESOURCE),
        ("clazy", "clazy-heap-allocated-small-trivial-type", FindingCategory.RESOURCE),
        ("clazy", "clazy-qdeleteall", FindingCategory.RESOURCE),
        ...
        ("clazy", "clazy-detaching-temporary-helper", FindingCategory.MAINTAINABILITY),
